              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">الخلفية المهنية (Professional Background)</label>
                    <textarea
                      value={activeProfile.professionalBackground || ''}
                      onChange={(e) => handleUpdateProfile(activeProfile.id, { professionalBackground: e.target.value })}
                      ...
                      placeholder="مثال: خبرة سابقة في شركات التقنية الكبرى، أو خلفية قوية في إدارة الفرق..."
                    />
                  </div>
                  <div className="md:col-span-2">
